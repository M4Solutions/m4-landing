    ...
    return ( 
        ...
        <footer className="container mx-auto px-6 text-white">
            <div className="grid lg:grid-cols-3 space-x-auto">
                <div className="mb-6 md:mb-0">
                    <a href="/" className="flex justify-center md:justify-start items-center mb-6">
                        ...
                        <span className="self-center text-2xl font-semibold whitespace-nowrap">M4 SOLUTIONS</span>
                    </a>
                    <p className="max-w-lg">M4 Solution Limited focuses on providing high-quality printing solutions with integrity and honesty, resulting in long-lasting business relationships.</p>
                </div>
                <div className="">
                    <h2 className="mb-6 text-sm font-semibold uppercase text-white">OUR CONTACT</h2>
                    <ul className="">
                        <li className="mb-4">
                            <a href="/" className="hover:underline">1-800-1234-567</a>
                        </li>
                        <li className="mb-4">
                ...
                <div className="">
                    <h2 className="mb-6 text-sm font-semibold   uppercase text-white">OUR SOCIALS</h2>
                    <div className="flex mt-4 space-x-6 sm:justify-start sm:mt-0">
            ...
            <div className="text-center text-sm">
               © 2023 <a href="/" className="hover:underline">M4 solutions</a>. All Rights Reserved.
            </div>
        </footer>
